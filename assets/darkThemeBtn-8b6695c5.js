import{a as b,i as w}from"./vendor-ce9f25a7.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function a(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=a(s);fetch(s.href,r)}})();document.addEventListener("DOMContentLoaded",function(){let e=window.location.href,t=document.getElementById("homeLink"),a=document.getElementById("favoritesLink"),n=document.getElementById("mobileHomeLink"),s=document.getElementById("mobileFavoritesLink");e.includes("index.html")?(t.classList.add("active"),a.classList.remove("active"),n.classList.add("active"),s.classList.remove("active")):e.includes("favourite.html")&&(a.classList.add("active"),t.classList.remove("active"),s.classList.add("active"),n.classList.remove("active"))});const B=document.querySelector(".open-mobile-menu-btn"),q=document.querySelector(".close-mobile-menu-btn"),d=document.querySelector(".mobile-menu-wrapper");B.addEventListener("click",function(){d.classList.add("is-open"),document.body.classList.add("not-scrollable"),setTimeout(()=>{d.classList.add("mobile-menu-wrapper-anim")},2500)});q.addEventListener("click",function(){document.body.classList.remove("not-scrollable"),d.classList.add("mobile-menu-wrapper-anim-hide"),setTimeout(function(){d.classList.remove("is-open"),d.classList.remove("mobile-menu-wrapper-anim")},1400)});d.addEventListener("animationend",e=>{e.animationName==="mobile-menu-wrapper-hide-animation"&&d.classList.remove("mobile-menu-wrapper-anim-hide")});const I="https://energyflow.b.goit.study/api";b.defaults.baseURL=I;async function V(){return(await b.get("/quote")).data}async function W(e){return(await b.post("/subscription",{email:e})).data}async function $(e,{email:t,rate:a,comment:n}){return await b.patch(`/exercises/${e}/rating`,{rate:a,email:t,review:n})}const F=document.getElementById("form-close-btn"),u=document.querySelector(".backdrop"),C=document.querySelector("#user-email"),O=document.getElementById("user-comment"),T=document.querySelector(".form-send-btn");F.addEventListener("click",()=>{u.classList.remove("is-open")});u.addEventListener("click",e=>{e.target===u&&u.classList.remove("is-open")});const A=document.querySelector(".rating-wrapper"),S=document.querySelector(".rating-star-value"),i={rate:0,email:"",comment:""};A.addEventListener("click",e=>{const t=document.querySelectorAll(".rating-star-icons");i.rate=e.target.dataset.id;for(let a=0;a<5;a++)a<i.rate?(t[a].style.fill="#EEA10C",S.textContent=i.rate===void 0?"0.0":`${i.rate}.0`):(t[a].style.fill="rgba(27, 27, 27, 0.20)",S.textContent=i.rate===void 0?"0.0":`${i.rate}.0`)});let x=null;const j=document.querySelector(".backdrop-form");function M(e){x=e,u.classList.add("is-open")}j.addEventListener("submit",N);async function N(e){if(e.preventDefault(),i.email=C.value.trim(),i.comment=O.value.trim(),i.email!==""&&i.rate!==0){T.disabled=!1;try{const t=await $(x,i);w.success({message:"Your rating is accepted",position:"topRight",color:"green"}),u.classList.remove("is-open")}catch(t){w.error({message:`${t.message}`,position:"topRight",color:"red"}),u.classList.remove("is-open")}}}const m="favourite",P=e=>{localStorage.setItem(m,JSON.stringify(e))},y=e=>{try{return JSON.parse(localStorage.getItem(e))}catch(t){console.log(t.message)}},E=e=>{const t=y(m).filter(a=>a._id!==e);localStorage.removeItem(m),localStorage.setItem(m,JSON.stringify(t))},c=document.querySelector(".exr-card-backdrop");let l=!1,p=[],k=JSON.parse(localStorage.getItem("favourite"));k&&k.forEach(e=>{p[0]||(p[0]=e),p.push(e)});function v(e){return`${e.charAt(0).toUpperCase()}${e.slice(1)}`}function R(e,t=!1,a=!1){l=t,l||p.forEach(n=>{n._id===e._id&&(l=!0)}),H(e),c.classList.add("card-is-open"),document.body.classList.add("not-scrollable"),l===!0&&(document.querySelector(".add-favourite-btn").innerHTML=`Remove from
    ...
    <div>
      ...
      <div class="buttons-cont">
        ...
        </li>`);f.cardSet.innerHTML=a.join("")},J=e=>{const t=e.target.closest('[data-action="start_exercise_btn"]'),a=e.target.closest('[data-action="delete_fav_card"]'),n=e.target.closest('[data-component="fav_card"]');if(!(!e.target.tagName==="BUTTON"||!a&&!t)){if(a)if(a.dataset.idDelBtn===n.dataset.idCard){const s=a.dataset.idDelBtn;E(s),L()}else return;else if(t){const s=t.dataset.idStartBtn,o=y(m).find(_=>_._id===s);R(o,!0,!0)}}},L=()=>{document.querySelector(".favourite_exercises")!==null&&(y(m).length!==0?(f.noCards.classList.add("visually-hidden"),f.cardSet.classList.remove("visually-hidden"),U(y(m)),f.cardSet.addEventListener("click",J)):(f.noCards.classList.remove("visually-hidden"),f.cardSet.classList.add("visually-hidden")))};L();let g=null;const h=document.getElementById("theme-stylesheet");document.addEventListener("DOMContentLoaded",function(){g=window.innerWidth>1440?document.getElementById("checkbox"):document.getElementById("theme-checkbox"),localStorage.getItem("theme")==="dark"?t():a(),g.addEventListener("change",function(){g.checked?(t(),localStorage.setItem("theme","dark")):(a(),localStorage.setItem("theme","light"))});function t(){h?h.href="./css/dark-theme.css":console.error("themeStylesheet element not found"),g.checked=!0}function a(){h?h.href="./css/index.css":console.error("themeStylesheet element not found")}});export{V as g,R as h,W as p};
//# sourceMappingURL=darkThemeBtn-8b6695c5.js.map
